...
class Config:
    ...
    def __init__(self):
        ...
        self.n_power_levels = 10  # number of discrete power levels
        ...
        self.total_slots = 50000   # total time slots in the simulation
        #self.U = 2  # number of neighbors taken into consideration
